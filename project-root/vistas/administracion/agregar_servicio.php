...
include __DIR__ . '/../../vistas/plantillas/admin_header.php';
?>
...
<div class="container mt-4">
    ...
    <form action="procesar_servicio.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="whatsapp" class="form-label">Enlace de WhatsApp:</label>
            <input type="url" id="whatsapp" name="whatsapp" class="form-control" placeholder="Ejemplo: https://wa.me/1234567890" required>
